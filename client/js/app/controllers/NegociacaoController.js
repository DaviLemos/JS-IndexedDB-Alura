...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/Bind', '../models/Negociacao'], function (_export, _context) {
  ...
  var ListaNegociacoes, Mensagem, NegociaosesView, MensagemView, NegociacaoService, DateHelper, Bind, Negociacao, _createClass, NegociacaoController, negociacaoController;
  ...
  return {
    setters: [function (_modelsListaNegociacoes) {
      ...
      NegociaosesView = _viewsNegociacoesView.NegociaosesView;
    ...
    execute: function () {
      ...
      NegociacaoController = function () {
        function NegociacaoController() {
          ...
          this._listaNegociacoes = new Bind(new ListaNegociacoes(), new NegociaosesView($('#negociacoesView')), 'adiciona', 'esvazia', 'ordena', 'inverteOrdem');
