    ...
    execute: function () {
      ...
      _export('NegociacaoService', NegociacaoService = function () {
        ...
        _createClass(NegociacaoService, [{
          ...
          key: 'obterNegociacoesDaAnterior',
          value: function obterNegociacoesDaAnterior() {
          ...
          key: 'obterNegociacoesDaRetrasada',
          value: function obterNegociacoesDaRetrasada() {
          ...
          value: function obterNegociacoes() {
            return Promise.all([this.obterNegociacoesDaSemana(), this.obterNegociacoesDaAnterior(), this.obterNegociacoesDaRetrasada()]).then(function (peridos) {
              var negociacoes = peridos.reduce(function (arrayAchatado, array) {
          ...
          key: 'importa',
          value: function importa(listaAtural) {
            return this.obterNegociacoes().then(function (negociacoes) {
              return negociacoes.filter(function (negociacao) {
                return !listaAtural.some(function (negociacaoExistente) {
